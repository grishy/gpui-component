...
use gpui::{
    AccessibleAction, Animation, AnimationExt as _, App, Background, ElementId, Hsla,
    InteractiveElement, IntoElement, MouseButton, ParentElement as _, RenderOnce, Role,
    SharedString, StatefulInteractiveElement as _, StyleRefinement, Styled, Toggled, Window,
...
impl RenderOnce for Switch {
    fn render(self, window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        let focus_handle = window
            .use_keyed_state(format!("{}-focus", self.id), cx, |_, cx| cx.focus_handle())
            .read(cx)
            .clone();
